        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          ...
          <div className="bg-slate-900 p-6 rounded-3xl shadow-lg text-white flex flex-col justify-center items-center text-center">
            ...
            <button 
              ...
              className="bg-white text-slate-900 font-bold px-6 py-2 rounded-full hover:bg-blue-400 transition-colors"
            >
              Log Workout
            </button>
          </div>
          ...
          <div className="divide-y divide-slate-50">
            {workouts.length > 0 ? (
              workouts.slice(0, 5).map(w => (
                <div key={w._id || w.id} className="p-4 flex items-center justify-between hover:bg-slate-50 transition-colors">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-bold text-slate-800">{w.type || 'Workout'}</p>
