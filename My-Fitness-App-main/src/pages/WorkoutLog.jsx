...
const WorkoutLog = () => {
  const [workouts, setWorkouts] = useLocalStorage('my-workouts', []);
  ...
  const addWorkout = (e) => {
    ...
    setWorkouts([newWorkout, ...workouts]); // Newest first
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
              ...
              <div className="divide-y divide-slate-100">
                {workouts.length === 0 ? (
                  ...
                  workouts.map(w => (
                    <div key={w.id} className="p-5 flex items-center justify-between group hover:bg-blue-50/30 transition-colors">
